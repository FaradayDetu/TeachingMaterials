...
\institute[CREAL]{BRGE - Bioinformatics Research Group in Epidemiology \\
		  Barcelona Institute for Global Health (ISGlobal) \\
                  {\tt Center for Research in Environmental Epidemiology (CREAL)} \\
...
\begin{frame}\frametitle{Mendelian randomization}
...
\begin{frame}\frametitle{Conditional Independent Test (CIT)}

\begin{figure}
  \includegraphics[height=4cm, width=6cm]{figures/CIT.png}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{One omic dataset: dimensionality reduction}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
\begin{center}
 \includegraphics[width=5.5cm]{figure/plot_cia-1}
\end{center}
\end{figure}

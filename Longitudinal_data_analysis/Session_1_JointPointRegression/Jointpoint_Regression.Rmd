...
In some ocassion the user is interested in selecting the best modelby using an automatic method by using backward or forward approaches
Si queremos escoger el modelo de forma automática, utilizamos un método de selección 'backward' o 'forward'. This can be performed by using the function `ljrb` or `ljrf`.
...
* Visualy detect how many changes of trens (e.g. joinpoints) whold fit the data

...
Los modelos no lineales son una generalización del modelo lineal de regresión
en los que la media condicionada de la variable respuesta, no es una función lineal de 
los parámeros
...
It can be estimated as $-\hat{\theta_3}/\hat{\theta_2}$. In our case 
